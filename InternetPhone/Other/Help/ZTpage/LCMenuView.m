...
@interface LCMenuView ()<UIScrollViewDelegate>
...
- (void)setTitlesArr:(NSArray *)titlesArr {
    ...
    [self loadWithScollviewAndBtnWithTitles:titlesArr];
}
...
//    MenuScrollView.backgroundColor = BASECOLOR;
    ...
    titlesArr = [NSMutableArray arrayWithArray:titles];
    NSArray *imageArr = @[@"1@3x20170720",@"9@3x20170720",@"21@3x20170720",@"11@3x20170720"];
    NSArray *imageSelectArr = @[@"3@3x20170720",@"9@3x20170720",@"21@3x20170720",@"11@3x20170720"];
    
    for (int i = 0; i < titles.count; i++) {
        
//        
//        MenuViewBtn *btn = [[MenuViewBtn alloc ]initWithTitles:titlesArr AndIndex:i];
        MenuViewBtn *btn = [MenuViewBtn buttonWithType:UIButtonTypeCustom];
        btn.tag = i;
        if (self.style == MenuViewStyleFoold || self.style == MenuViewStyleFooldHollow) {
            btn.fontName = @"BodoniSvtyTwoOSITCTT-Bold";
            btn.fontSize = kNormalSize;
            ...
            btn.fontName = @"PingFang SC Regular";
        }
...
//        [btn setFrame:HCGRECT(0, 0, 40, 40)];
        [self.MenuScrollView addSubview:btn];
        UIView *vvvv = [[UIView alloc] initWithFrame:HCGRECT(0, 0, 0, 0)];
        vvvv.backgroundColor = BASECOLOR;
//          [self.MenuScrollView addSubview:vvvv];
...
//        if (![btn isKindOfClass:[MenuViewBtn class]]) {
//            return;
//        }
//        if (i>=1) {
...
////        lineView.backgroundColor = [UIColor colorWithRGB:0xF2F2F2];
