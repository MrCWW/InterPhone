...
@property (nonatomic,weak)LCMenuView *MenuView;
...
@property (nonatomic,strong) NSMutableArray *dataBannerArray;
@property (nonatomic, strong) NSMutableArray *imagesBannerURLStrings;

@end

@implementation ZTViewController

- (NSMutableArray *)dataBannerArray {
    if (!_dataBannerArray) {
        _dataBannerArray = [NSMutableArray array];
    }
    return  _dataBannerArray;
}
- (NSMutableArray *)imagesBannerURLStrings {
    if (!_imagesBannerURLStrings) {
        _imagesBannerURLStrings = [NSMutableArray array];
    }
    return _imagesBannerURLStrings;
}
...
- (void)loadMenuViewWithTitles:(NSArray *)titles
{
    ...
    LCMenuView *Menview = [[LCMenuView alloc]initWithMneuViewStyle:self.style AndTitles:titles frame:CGRectMake(0,Banners_Height, ScreenWidth, MenuHeight)];
...
//    self.MenuView.frame = CGRectMake(0, 0, ScreenWidth, MenuHeight);
    self.detailScrollView.frame = CGRectMake(0, self.MenuView.y+self.MenuView.height, ScreenWidth,ScreenHeight - self.detailScrollView.y+140*WidthIphone6);
...
- (void)addViewControllerViewAtIndex:(int)index
{
  ...
  [vc setValue:self.titles[index] forKey:@"titles"];
    NSLog(@"%@",vc);
...
//        UINavigationController *vc = [[UINavigationController alloc] initWithRootViewController:vcV];
