...
- (UIButton *)leftBtn {
    if (!_leftBtn) {
        ...
        _leftBtn.backgroundColor = [UIColor colorWithRed:36.0/255 green:116.0/255  blue:172.0/255 alpha:1.0f];
...
- (UIButton *)rightBtn {
    if (!_rightBtn) {
        ...
        _rightBtn.backgroundColor = [UIColor colorWithRed:36.0/255 green:116.0/255  blue:172.0/255 alpha:1.0f];
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        ...
        _titleLabel.textColor = [UIColor colorWithRed:36.0/255 green:116.0/255  blue:172.0/255 alpha:1.0f];
...
- (UIView *)lineView {
    if (!_lineView) {
        _lineView = [[UIView alloc]initWithFrame:CGRectMake(0, kTopViewHeight, SCREEN_WIDTH, 1)];
